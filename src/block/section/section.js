...
registerBlockType( 'next24hr/section', {
    ...
    edit: function( props ) {
        ...
        const removeBgImage = () => {
            props.setAttributes({ backgroundValue: null });
        };
        ...
        const mediaOptions = (
            ...
            <PanelRow>
                <MediaUploadCheck>
                    <MediaUpload
                        onSelect={ ( media ) => props.setAttributes({ backgroundValue: media }) }
        ...
        const colorOptions = (
            <PanelRow>
                <ColorPalette
                    ...
                    onChange={ color => {
                        props.setAttributes({ backgroundValue: color });
