...
/* harmony import */ var _column_style__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./column.style */ "./src/block/section/column.style.js");
...
registerBlockType('next24hr/column', {
  ...
  edit: function (props) {
    ...
    return (0,_emotion_react__WEBPACK_IMPORTED_MODULE_2__.jsx)(_column_style__WEBPACK_IMPORTED_MODULE_1__.StyledBlockRoot, null, (0,_emotion_react__WEBPACK_IMPORTED_MODULE_2__.jsx)(_column_style__WEBPACK_IMPORTED_MODULE_1__.StyledColumnLabel, null), (0,_emotion_react__WEBPACK_IMPORTED_MODULE_2__.jsx)(_emotion_react__WEBPACK_IMPORTED_MODULE_2__.Global, {
      styles: _column_style__WEBPACK_IMPORTED_MODULE_1__.globalCss
    }), (0,_emotion_react__WEBPACK_IMPORTED_MODULE_2__.jsx)(InspectorControls, null, (features.includes('aligment') || features.includes('direction')) && (0,_emotion_react__WEBPACK_IMPORTED_MODULE_2__.jsx)(PanelBody, {
      title: __('Column Options', 'next24hr')
    }, features.includes('aligment') && (0,_emotion_react__WEBPACK_IMPORTED_MODULE_2__.jsx)(PanelRow, null, (0,_emotion_react__WEBPACK_IMPORTED_MODULE_2__.jsx)(ButtonGroup, null, (0,_emotion_react__WEBPACK_IMPORTED_MODULE_2__.jsx)(Button, {
      css: _column_style__WEBPACK_IMPORTED_MODULE_1__.buttonCss,
      isLarge: true,
      value: 'left',
    ...
    }, (0,_emotion_react__WEBPACK_IMPORTED_MODULE_2__.jsx)(Dashicon, {
    ...
    })))), features.includes('direction') && (0,_emotion_react__WEBPACK_IMPORTED_MODULE_2__.jsx)(PanelRow, null, (0,_emotion_react__WEBPACK_IMPORTED_MODULE_2__.jsx)(RadioControl, {
      label: __('Direction of elements', 'next24hr'),
      selected: direction,
      options: [{
        label: __('Column', 'next24hr'),
        value: 'column'
      }, {
        label: __('Row', 'next24hr'),
        value: 'row'
      }],
      onChange: value => props.setAttributes({
        direction: value
      })
    })))), (0,_emotion_react__WEBPACK_IMPORTED_MODULE_2__.jsx)(InnerBlocks
    // use the pre-made button block appender (not the default paragraph one)
    , {
      renderAppender: () => (0,_emotion_react__WEBPACK_IMPORTED_MODULE_2__.jsx)(InnerBlocks.ButtonBlockAppender, null),
  ...
  save: function () {
    return (0,_emotion_react__WEBPACK_IMPORTED_MODULE_2__.jsx)("div", null, (0,_emotion_react__WEBPACK_IMPORTED_MODULE_2__.jsx)(InnerBlocks.Content, null));
  }
});

/***/ }),

/***/ "./src/block/section/column.style.js":
/*!*******************************************!*\
  !*** ./src/block/section/column.style.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "StyledBlockRoot": () => (/* binding */ StyledBlockRoot),
/* harmony export */   "StyledColumnLabel": () => (/* binding */ StyledColumnLabel),
...
const StyledColumnLabel = _emotion_styled__WEBPACK_IMPORTED_MODULE_0__["default"].div`
    position: relative;
...
`;
const StyledBlockRoot = _emotion_styled__WEBPACK_IMPORTED_MODULE_0__["default"].div`
    color: #000;
    display: block;
    width: 100%;
    ...
    flex: 1;
`;
const buttonCss = _emotion_react__WEBPACK_IMPORTED_MODULE_1__.css`
	display: inline-flex;
	align-items: center;
`;
const globalCss = _emotion_react__WEBPACK_IMPORTED_MODULE_1__.css`
...
/* harmony import */ var _template_select_button_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./template-select-button.js */ "./src/block/section/template-select-button.js");
/* harmony import */ var _section_style__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./section.style */ "./src/block/section/section.style.js");
/* harmony import */ var _template_options__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./template-options */ "./src/block/section/template-options.js");
...
const defaultWidths = [{
  label: __('Follows normal flow', 'next24hr'),
  value: 'normal'
}, {
  label: __('Background full width', 'next24hr'),
  value: 'constrained'
}, {
  label: __('All full width', 'next24hr'),
  value: 'full'
}
...
const defaultBackgroundTypes = [{
  label: __('Transparent', 'next24hr'),
  value: 'transparent'
}, {
  label: __('Color', 'next24hr'),
  value: 'color'
}, {
  label: __('Image', 'next24hr'),
  value: 'image'
}];
registerBlockType('next24hr/section', {
  ...
  attributes: {
    templateSelected: {
      type: 'array',
      default: [..._template_options__WEBPACK_IMPORTED_MODULE_3__.TEMPLATE_OPTIONS[0].template]
    },
    templateID: {
      type: 'number',
      default: _template_options__WEBPACK_IMPORTED_MODULE_3__.DEFAULT_TEMPLATE_INDEX
    },
    verticalAlignment: {
      type: 'string',
      default: 'top'
    ...
    backgroundTypesSelection: {
      type: 'array',
      default: defaultBackgroundTypes
    },
    mobileDesktopFilter: {
      type: 'string'
    },
    ...
    features: {
      type: 'array',
      default: ['background', 'verticalAlignment', 'width', 'verticalPadding', 'background.image', 'background.color', 'mobileDesktopFilter', 'anchorTarget', 'disableTemplates']
    }
  },
  keywords: [__('next24hr-section — CGB Block'), __('CGB Example'), __('create-guten-block')],
  edit: function (props) {
    const {
      setAttributes,
      extraTemplates,
    ...
    const getVisibilityInfo = function () {
      let mobileDesktopFilter = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'all';
    ...
    (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
      if (!templateSelected) {
        templateSelectHandler(_template_options__WEBPACK_IMPORTED_MODULE_3__.DEFAULT_TEMPLATE_INDEX, false);
      }
    }, []);
    const image = backgroundType === 'image' ? backgroundValue : null;
    const ALL_TEMPLATES = [..._template_options__WEBPACK_IMPORTED_MODULE_3__.TEMPLATE_OPTIONS.filter(template => {
      if (!disableTemplates || disableTemplates.length === 0) {
        return true;
      }
      return !disableTemplates.includes(template.slug);
    }), ...(extraTemplates || [])];
    const templateSelectHandler = function (templateIndex) {
    ...
    const templateOptions = ALL_TEMPLATES.map((templateOption, index) => {
      return (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(_template_select_button_js__WEBPACK_IMPORTED_MODULE_1__["default"], {
    ...
    const mediaOptions = (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)("div", {
      css: _emotion_react__WEBPACK_IMPORTED_MODULE_4__.css`
                display: flex;
                flex-direction: column;
                align-items: center;
            `
    }, !image ? (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)("small", {
      css: _emotion_react__WEBPACK_IMPORTED_MODULE_4__.css`color: red;`
    }, __('No image selected', 'next24hr')) : null, (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(PanelRow, null, (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(MediaUploadCheck, null, (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(MediaUpload, {
      onSelect: media => setAttributes({
        backgroundValue: media
      }),
      ...
      render: _ref => {
        ...
        return (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)("div", null, (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(BaseControl, {
          css: _emotion_react__WEBPACK_IMPORTED_MODULE_4__.css`
                                            display: flex;
                                            justify-content: end;
                                            margin-top: 0.5rem;
                                        `
        }, (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(ButtonGroup, null, (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(Button, {
          isDefault: true,
          onClick: open
        }, image ? __('Change image', 'next24hr') : __('Add image', 'next24hr')), image ? imageDeleteButton : null)));
      }
    }))), image ? (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)("img", {
    ...
    const colorOptions = (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(PanelRow, null, (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(ColorPalette, {
    ...
    const imageDeleteButton = (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(Button, {
      isDefault: true,
    ...
    const updateBackgroundType = backgroundType => {
      ...
      const newAttributes = {
        backgroundType,
        backgroundValue: defaultValuesByType[backgroundType]
      };
      setAttributes({
        ...newAttributes
      });
    ...
    const getInfoBoxListHtml = () => {
      const infoBoxListHtml = infoBoxList.map(item => {
        return (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(_section_style__WEBPACK_IMPORTED_MODULE_2__.StyledInfoItem, {
          style: item.style,
          onClick: e => item.callback(e)
        }, item.content);
      });
      if (infoBoxList.length > 0) {
        return (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(_section_style__WEBPACK_IMPORTED_MODULE_2__.StyledInfoBox, null, infoBoxListHtml);
      }
      return null;
    };
    ...
    const sectionCss = _emotion_react__WEBPACK_IMPORTED_MODULE_4__.css`
    ...
    const getVisibilityFilterPanel = () => {
      if (features.includes('mobileDesktopFilter')) {
        return (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(PanelBody, {
          title: "Visibility",
          initialOpen: false
        }, (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(RadioGroup, {
          accessibilityLabel: "Visibility",
          onChange: value => setAttributes({
            mobileDesktopFilter: value
          }),
          checked: mobileDesktopFilter
        }, (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(Radio, {
          value: "all"
        }, "All"), (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(Radio, {
          value: "mobile"
        }, "Mobile"), (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(Radio, {
          value: "desktop"
        }, "Desktop")));
      }
    };
    return (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(_section_style__WEBPACK_IMPORTED_MODULE_2__.StyledBlockRoot, null, getInfoBoxListHtml(), (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(_section_style__WEBPACK_IMPORTED_MODULE_2__.StyledSectionLabel, null), (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(InspectorControls, null, (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(PanelBody, {
      title: __('Section Layout Options', 'next24hr')
    }, (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(PanelRow, null, (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)("div", {
      css: _emotion_react__WEBPACK_IMPORTED_MODULE_4__.css`
                                display: flex;
                                flex-wrap: wrap;
                                justify-content: center;
                            `
    }, templateOptions))), (features.includes('background') || backgroundType === 'color' || backgroundType === 'image') && (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(PanelBody, {
      title: __('Background', 'next24hr'),
      initialOpen: true
    }, features.includes('background') && (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(PanelRow, null, (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(RadioControl, {
      label: __('Background', 'next24hr'),
      selected: backgroundType,
      options: backgroundTypesSelection,
      onChange: updateBackgroundType
    })), backgroundType === 'color' ? colorOptions : null, backgroundType === 'image' ? mediaOptions : null), (features.includes('verticalPadding') || features.includes('verticalAlignment') || features.includes('width')) && (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(PanelBody, {
      title: __('Spacing', 'next24hr'),
      initialOpen: false
    }, features.includes('verticalPadding') && (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)("div", null, (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(PanelRow, null, (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(RadioControl, {
      label: __('Padding Top', 'next24hr'),
      selected: paddingTop,
      options: [{
        label: __('None', 'next24hr'),
        value: 'none'
      }, {
        label: __('Medium', 'next24hr'),
        value: 'medium'
      }, {
        label: __('Big', 'next24hr'),
        value: 'big'
      }],
      onChange: value => setAttributes({
        paddingTop: value
      })
    })), (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(PanelRow, null, (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(RadioControl, {
    ...
    }))), features.includes('verticalAlignment') && (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(PanelRow, null, (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(RadioControl, {
      label: __('Vertical alignment', 'next24hr'),
      selected: verticalAlignment,
      options: [{
        label: __('Top', 'next24hr'),
        value: 'top'
      }, {
        label: __('Center', 'next24hr'),
        value: 'center'
      }, {
        label: __('Bottom', 'next24hr'),
        value: 'bottom'
      }],
      onChange: verticalAlignment => updateVerticalAlignmentSetting(verticalAlignment, null)
    })), features.includes('width') && (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(PanelRow, null, (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(RadioControl, {
    ...
    }))), getVisibilityFilterPanel(), features.includes('anchorTarget') && (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(PanelBody, {
      title: "Anchor Target",
      initialOpen: false
    }, (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(PanelRow, {
      ref: anchorTargetRef
    }, (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(TextControl, {
      label: __('Anchor Name'),
      value: anchorTarget,
      onChange: value => setAttributes({
        anchorTarget: value.replace(/^#/g, '')
      })
    })))), (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(_section_style__WEBPACK_IMPORTED_MODULE_2__.StyledContainer, {
      templateID: templateID,
      css: sectionCss,
      allTemplates: ALL_TEMPLATES
    }, (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(InnerBlocks
  ...
  save: function () {
    return (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)("div", null, (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.jsx)(InnerBlocks.Content, null));
  }
});
...
/***/ "./src/block/section/section.style.js":
/*!********************************************!*\
  !*** ./src/block/section/section.style.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "StyledInfoBox": () => (/* binding */ StyledInfoBox),
/* harmony export */   "StyledInfoItem": () => (/* binding */ StyledInfoItem),
/* harmony export */   "StyledSectionLabel": () => (/* binding */ StyledSectionLabel)
/* harmony export */ });
/* harmony import */ var _emotion_styled__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @emotion/styled */ "./node_modules/@emotion/styled/dist/emotion-styled.browser.esm.js");
/* harmony import */ var _template_options__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./template-options */ "./src/block/section/template-options.js");


const StyledContainer = _emotion_styled__WEBPACK_IMPORTED_MODULE_0__["default"].div`
    margin: 0 auto;
    max-width: 1100px;
    position: relative;
    & > div > .block-editor-block-list__layout {
        display: grid;
        grid-template-columns: ${p => p.templateID && p.allTemplates ? p.allTemplates[p.templateID].style : _template_options__WEBPACK_IMPORTED_MODULE_1__.TEMPLATE_OPTIONS[_template_options__WEBPACK_IMPORTED_MODULE_1__.DEFAULT_TEMPLATE_INDEX].style};
        grid-column-gap: 8px;
    }
`;
const StyledBlockRoot = _emotion_styled__WEBPACK_IMPORTED_MODULE_0__["default"].div`
...
`;
const StyledSectionLabel = _emotion_styled__WEBPACK_IMPORTED_MODULE_0__["default"].div`
    position: relative;
    height: 15px;
    &:after {
        position: absolute;
...
`;
const StyledInfoBox = _emotion_styled__WEBPACK_IMPORTED_MODULE_0__["default"].div`
    position: absolute;
    display: flex;
    top: 3px;
    right: 0px;
...
`;
const StyledInfoItem = _emotion_styled__WEBPACK_IMPORTED_MODULE_0__["default"].div`
    margin: 0rem 0.17rem;
    padding: 0rem 8px;
`;
...
/***/ "./src/block/section/template-options.js":
/*!***********************************************!*\
  !*** ./src/block/section/template-options.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "DEFAULT_TEMPLATE_INDEX": () => (/* binding */ DEFAULT_TEMPLATE_INDEX),
...
const templates = [__webpack_require__(/*! ./templates.json */ "./src/block/section/templates.json")];
...
const TEMPLATE_OPTIONS = [{
  ...
  icon: (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(SVG, {
    ...
    fillRule: "evenodd",
    clipRule: "evenodd",
    d: "M39 12C40.1046 12 41 12.8954 41 14V34C41 35.1046 40.1046 36 39 36H9C7.89543 36 7 35.1046 7 34V14C7 12.8954 7.89543 12 9 12H39ZM39 34V14H10V34H39ZM23 34H9V14H10V34Z"
  })),
  template: templates[0][0]
}, {
  slug: 'twoColumnsEqual',
  ...
  slug: 'twoColumnsOneAndTwoThirds',
  ...
  slug: 'twoColumnsTwoAndOneThirds',
  ...
  icon: (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(SVG, {
    ...
    d: "M 24 34.742 L 24 13.282"
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Path, {
    d: "M 41 34 C 41 35.105 40.105 36 39 36 L 9 36 C 7.895 36 7 35.105 7 34 L 7 14 C 7 12.895 7.895 12 9 12 L 39 12 C 40.105 12 41 12.895 41 14 Z M 31 14 L 25 14 L 25 34 L 31 34 Z M 17 14 L 17 34 L 23 34 L 23 14 Z M 39 34 L 39 14 L 33 14 L 33 34 Z M 15 14 L 9 14 L 9 34 L 15 34 Z"
  })),
...
/***/ "./src/block/section/template-select-button.js":
/*!*****************************************************!*\
  !*** ./src/block/section/template-select-button.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const templateSelect = props => {
  return (0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__.jsx)(Button, {
...
/***/ "./src/block/section/templates.json":
/*!******************************************!*\
  !*** ./src/block/section/templates.json ***!
  \******************************************/
/***/ ((module) => {

module.exports = JSON.parse('[[["next24hr/column",{"width":"1/1"}]],[["next24hr/column",{"width":"1/2"}],["next24hr/column",{"width":"1/2"}]],[["next24hr/column",{"width":"1/3"}],["next24hr/column",{"width":"2/3"}]],[["next24hr/column",{"width":"2/3"}],["next24hr/column",{"width":"1/3"}]],[["next24hr/column",{"width":"1/3"}],["next24hr/column",{"width":"1/3"}],["next24hr/column",{"width":"1/3"}]],[["next24hr/column",{"width":"1/4"}],["next24hr/column",{"width":"1/2"}],["next24hr/column",{"width":"1/4"}]],[["next24hr/column",{"width":"1/4"}],["next24hr/column",{"width":"1/4"}],["next24hr/column",{"width":"1/4"}],["next24hr/column",{"width":"1/4"}]]]');
...
/*!***********************!*\
  ...
  \***********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _block_section_column_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./block/section/column.js */ "./src/block/section/column.js");
/* harmony import */ var _block_section_section_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block/section/section.js */ "./src/block/section/section.js");
/**
 * Gutenberg Blocks
 *
